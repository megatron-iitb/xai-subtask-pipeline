...
def main():
    ...
    logger.info(f"[OPTION A] Configuration: epochs={args.epochs}, batch_size={args.batch_size}, lr={args.lr}")
    logger.info(f"[OPTION A] Strategy: Best from Run 1 (batch=128, lr=1e-3) + Edge complexity")
